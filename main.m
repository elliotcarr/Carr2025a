...
% Test problems
tau = 0.001; problem = '1'; sigma_vals = [0,0.05]; te = 0.1; N = 1001;
% tau = 0.0007; problem = '2'; sigma_vals = [0,0.05]; te = 0.1; N = 1001;
% tau = 0.0004; problem = '3'; sigma_vals = [0,0.05];te = 0.1; N = 1001;
% tau = 0.0001; problem = '4'; sigma_vals = [0,0.05]; te = 0.1; N = 1001;
% tau = 0.0015; problem = '5'; sigma_vals = [0,0.05]; te = 0.1; N = 1001;
% tau = 0.003; problem = '6'; sigma_vals = [0,0.05]; te = 0.1; N = 1001;
% tau = 0.01; problem = '7'; sigma_vals = [0,0.05]; te = 0.4; N = 1001;
% tau = 0.03; problem = '8'; sigma_vals = [0,0.05]; te = 0.4; N = 1001;
...
for ii = 1:length(Ms_vals)
    ...
    dt = te/(N-1);
    fprintf('%i & \\num{%1.2e} & \\num{%1.4e} & \\num{%1.4e} & \\num{%1.4e} & \\num{%1.4e}\\\\\n',...
        N,dt,tau_approx_vals(ii,1),alpha_approx_vals(ii,1),...
...
for ii = 1:length(Ms_vals)
    ...
    dt = te/(N-1);
    fprintf('%i & \\num{%1.2e} & \\num{%1.4e} & \\num{%1.4e} & \\num{%1.4e} & \\num{%1.4e}\\\\\n',...
        N,dt,tau_approx_vals(ii,3),alpha_approx_vals(ii,3),...
